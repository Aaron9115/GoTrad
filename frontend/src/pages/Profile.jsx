...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Only password match check (no email validation on frontend)
              ...
              <div className="profile-info">
                {!isEditing ? (
                  ...
                  <form onSubmit={handleSubmit} className="profile-form">
                    ...
                    <div className="form-group">
                      <label><i className="ri-quote-line"></i> Bio</label>
                      <textarea 
                        name="bio" 
                        value={formData.bio} 
                        onChange={handleChange} 
                    ...
                    <div className="form-group">
                      <label><i className="ri-lock-line"></i> Confirm Password</label>
                      <input 
                        type="password" 
